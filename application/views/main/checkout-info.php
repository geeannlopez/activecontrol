            ...
            <td>
                ₱    <?php echo number_format($item['subtotal'],2) ?>
                                ...
                                <div class="box-footer">
                                    <div class="pull-left">
                                        <a href="<?=base_url()?>main/products" class="btn btn-default"><i class="fa fa-chevron-left"></i>Back to Shopping</a>
        ...
        paypal.Button.render({
            ...
            var amount = $('#paypal-button-container').data('amount');
                ...
                return actions.payment.create({
                    payment: {
                        transactions: [
                            {
                                amount: { total: amount, currency: 'PHP' }
                            }
                        ]
                    }
                });
            ...
            onAuthorize: function(data, actions) {
                ...
                return actions.payment.execute().then(function() {
                    window.location.href = "<?php echo site_url('main/save_order'); ?>";
                });
            }
