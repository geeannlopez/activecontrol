            ...
            <div class="homepage owl-carousel">
                <div class="item">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <img class="img-responsive" src="<?=base_url()?>/assets/img/template-homepage.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="item">
                    <div class="row">
                        ...
                        <div class="col-sm-7 text-center">
                            <img class="img-responsive" src="<?=base_url()?>/assets/img/template-mac.png" alt="">
                        </div>
                ...
                <div class="item">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <img class="img-responsive" src="<?=base_url()?>/assets/img/template-easy-customize.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="item">
                    <div class="row">
                        <div class="col-sm-7">
                            <img class="img-responsive" src="<?=base_url()?>/assets/img/template-easy-code.png" alt="">
                        </div>
                        <div class="col-sm-5">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 text-center">
                <img src="<?=base_url()?>/assets/img/template-easy-customize.png" alt="" class="img-responsive">
            </div>
        </div>
    </div>
</section>
...
<section class="bar no-mb color-white padding-big text-center-sm">
    <div class="container">
        <div class="row">
            <div class="col-md-6 text-center">
                <img src="<?=base_url()?>/assets/img/template-easy-code.png" alt="" class="img-responsive">
            </div>
            <div class="col-md-6">
        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="owl-carousel customers">
                    <li class="item">
                        <img src="<?=base_url()?>/assets/img/customer-1.png" alt="" class="img-responsive">
                    </li>
                    <li class="item">
                        <img src="<?=base_url()?>/assets/img/customer-2.png" alt="" class="img-responsive">
                    </li>
                    <li class="item">
                        <img src="<?=base_url()?>/assets/img/customer-3.png" alt="" class="img-responsive">
                    </li>
                    <li class="item">
                        <img src="<?=base_url()?>/assets/img/customer-4.png" alt="" class="img-responsive">
                    </li>
                    <li class="item">
